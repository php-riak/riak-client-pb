...
/**
 * Protobuf message : DtFetchReq
 */
class DtFetchReq extends \Protobuf\AbstractMessage
{
    ...
    /**
     * include_context optional bool = 11
     *
     * @var bool
     */
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->bucket === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\DtFetchReq#bucket" (tag 1) is required but has no value.');
        }

        if ($this->key === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\DtFetchReq#key" (tag 2) is required but has no value.');
        }

        if ($this->type === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\DtFetchReq#type" (tag 3) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\DtFetchReq) {
