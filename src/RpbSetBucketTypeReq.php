...
/**
 * Protobuf message : RpbSetBucketTypeReq
 */
class RpbSetBucketTypeReq extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->type === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\RpbSetBucketTypeReq#type" (tag 1) is required but has no value.');
        }

        if ($this->props === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\RpbSetBucketTypeReq#props" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\RpbSetBucketTypeReq) {
