...
/**
 * Protobuf message : RpbSearchDoc
 */
class RpbSearchDoc extends \Protobuf\AbstractMessage
{
     ...
     */
    public function addFields(\Riak\Client\ProtoBuf\RpbPair $value)
    {
        if ($this->fields === null) {
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\RpbSearchDoc) {
