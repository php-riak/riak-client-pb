...
/**
 * Protobuf message : RpbYokozunaIndexGetReq
 */
class RpbYokozunaIndexGetReq extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\RpbYokozunaIndexGetReq) {
