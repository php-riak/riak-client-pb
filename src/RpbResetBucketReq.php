...
/**
 * Protobuf message : RpbResetBucketReq
 */
class RpbResetBucketReq extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->bucket === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\RpbResetBucketReq#bucket" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\RpbResetBucketReq) {
