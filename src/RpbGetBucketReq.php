...
/**
 * Protobuf message : RpbGetBucketReq
 */
class RpbGetBucketReq extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->bucket === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\RpbGetBucketReq#bucket" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\RpbGetBucketReq) {
