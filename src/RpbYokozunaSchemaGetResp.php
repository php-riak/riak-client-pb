...
/**
 * Protobuf message : RpbYokozunaSchemaGetResp
 */
class RpbYokozunaSchemaGetResp extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->schema === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\RpbYokozunaSchemaGetResp#schema" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\RpbYokozunaSchemaGetResp) {
