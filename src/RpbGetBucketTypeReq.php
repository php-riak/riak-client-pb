...
/**
 * Protobuf message : RpbGetBucketTypeReq
 */
class RpbGetBucketTypeReq extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->type === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\RpbGetBucketTypeReq#type" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\RpbGetBucketTypeReq) {
