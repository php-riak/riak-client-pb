...
/**
 * Protobuf message : DtValue
 */
class DtValue extends \Protobuf\AbstractMessage
{
    ...
    /**
     * counter_value optional sint64 = 1
     *
     * @var int
     */
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\DtValue) {
