...
/**
 * Protobuf message : RpbListKeysReq
 */
class RpbListKeysReq extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->bucket === null) {
            throw new \UnexpectedValueException('Field "\\Riak\\Client\\ProtoBuf\\RpbListKeysReq#bucket" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\RpbListKeysReq) {
