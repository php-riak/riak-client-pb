...
/**
 * Protobuf message : RpbGetResp
 */
class RpbGetResp extends \Protobuf\AbstractMessage
{
     ...
     * @param bool $value
     */
    public function setUnchanged($value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setUnchanged($values['unchanged']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->unchanged !== null) {
            ...
            $writer->writeBool($stream, $this->unchanged);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 3) {
                ...
                $this->unchanged = $reader->readBool($stream);
    ...
    {
        if ( ! $message instanceof \Riak\Client\ProtoBuf\RpbGetResp) {
        ...
        $this->unchanged = ($message->unchanged !== null) ? $message->unchanged : $this->unchanged;
    }
