...
proto-generate:
	php $(BASEDIR)/vendor/bin/protobuf --include-descriptors -o $(BASEDIR)/src -i $(BASEDIR) $(BASEDIR)/riak.proto --psr4 Riak\\Client\\ProtoBuf

php-lint:
	find $(BASEDIR)/src -type f -name "*.php" -exec php -l {} \;

.PHONY: composer-install proto-generate php-lint help